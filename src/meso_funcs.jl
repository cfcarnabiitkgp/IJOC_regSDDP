...
PowerModels.jl
Public
Fork your own copy of lanl-ansi/PowerModels.jl
Code
Issues
97
Pull requests
...
Security
Insights
PowerModels.jl/src/core/objective.jl
@ccoffrin
ccoffrin Fix Int Types (#803)
…
Latest commit 4852055 on Jan 22, 2022
 History
 6 contributors
@ccoffrin@tasseff@yeesian@kersulis@jd-lara@pseudocubic
604 lines (486 sloc)  20.2 KB
...
"Adds lifted variables to turn a quadatic objective into a linear one;
